...
import net.dxs.wxhb.R;
import net.dxs.wxhb.R.layout;
import net.dxs.wxhb.R.menu;
import net.dxs.wxhb.utils.ConnectivityUtil;
import net.dxs.wxhb.utils.UpdateTask;
