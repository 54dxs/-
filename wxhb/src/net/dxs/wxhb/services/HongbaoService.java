package net.dxs.wxhb.services;

import java.util.List;

import net.dxs.wxhb.utils.HongbaoSignature;
import net.dxs.wxhb.utils.PowerUtil;
...
public class HongbaoService extends AccessibilityService implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	private void checkNodeInfo(int eventType) {
		...
		if (eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED && hasNodes && (currentActivityName.contains(WECHAT_LUCKMONEY_DETAIL_ACTIVITY) || currentActivityName.contains(WECHAT_LUCKMONEY_RECEIVE_ACTIVITY))) {
			mMutex = false;
